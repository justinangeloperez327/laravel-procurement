            ...
            <div className="grid gap-6 lg:grid-cols-2">
                        ...
                        >
                            ...
                            {appItems.map((item) => (
                                <option key={item.id} value={item.id}>
                                    ...
                                    {item.annual_procurement_plan.version} · Item{' '}
                                    {item.app_item_no} · {item.title} · Remaining{' '}
                ...
                <div className="space-y-2">
                    ...
                    <select
                        ...
                        onChange={(event) =>
                            setData('procurement_officer_id', event.target.value)
                        }
                        className="border-input bg-background h-10 w-full rounded-md border px-3 text-sm"
                    >
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={(event) =>
                            setData('target_completion_date', event.target.value)
                        }
                    />
