...
export default function EditProcurementProject(props: Props) {
    return (
        <>
            <Head title="Edit Procurement Project" />
            <div className="flex flex-1 flex-col p-4 md:p-6">
                <div className="mx-auto w-full max-w-5xl space-y-6">
                    <div className="flex items-start justify-between gap-4">
                        <Heading
                            title="Edit Procurement Project"
                            description="Update the planned project without changing its approved APP source."
                        />
