...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('procurement_role_assignments', function (Blueprint $table) {
            ...
            $table->unique(
                ['organization_id', 'organizational_unit_id', 'user_id', 'role'],
                'procurement_role_assignment_unique',
            );
            $table->index(
                ['organization_id', 'role', 'organizational_unit_id', 'is_active'],
                'procurement_role_lookup',
            );
        });
    }
